...
export const CONTEXT_ONLY_MEASUREMENT_FIELDS = [
  { key: "surface_m2", label: "Superficie m2", type: "number", options: [], sort_order: 9001, context_only: true, can_delete: false },
  { key: "budget_width_m", label: "Ancho presupuesto (m)", type: "number", options: [], sort_order: 9002, context_only: true, can_delete: false },
  { key: "budget_height_m", label: "Alto presupuesto (m)", type: "number", options: [], sort_order: 9003, context_only: true, can_delete: false },
  { key: "porton_type", label: "Presupuesto / Tipo-sistema", type: "text", options: [], sort_order: 9004, context_only: true, can_delete: false },
  ...
  { key: "current_user.is_vendedor", label: "Usuario actual / Es vendedor", type: "boolean", options: ["si", "no"], sort_order: 9043, context_only: true, can_delete: false },
  { key: "current_user.is_distribuidor", label: "Usuario actual / Es distribuidor", type: "boolean", options: ["si", "no"], sort_order: 9044, context_only: true, can_delete: false },
  { key: "current_user.is_superuser", label: "Usuario actual / Es superusuario", type: "boolean", options: ["si", "no"], sort_order: 9045, context_only: true, can_delete: false },
  { key: "current_user.is_medidor", label: "Usuario actual / Es medidor", type: "boolean", options: ["si", "no"], sort_order: 9046, context_only: true, can_delete: false },
  { key: "current_user.is_rev_tecnica", label: "Usuario actual / Es rev. técnica", type: "boolean", options: ["si", "no"], sort_order: 9047, context_only: true, can_delete: false },
  { key: "current_user.is_enc_comercial", label: "Usuario actual / Es enc. comercial", type: "boolean", options: ["si", "no"], sort_order: 9048, context_only: true, can_delete: false },
];

export const SYSTEM_MEASUREMENT_FIELDS = [
  { key: "nota_venta", label: "Nota de Venta / NV", type: "text", section: "datos_generales", editable_by: "tecnico", sort_order: 10 },
  { key: "fecha_nota_pedido", label: "Fecha de Nota de Pedido", type: "text", section: "datos_generales", editable_by: "tecnico", sort_order: 20 },
  { key: "fecha", label: "Fecha de medición", type: "text", section: "datos_generales", editable_by: "both", sort_order: 30 },
  { key: "distribuidor", label: "Distribuidor", type: "text", section: "datos_generales", editable_by: "tecnico", sort_order: 40 },
  { key: "cliente_nombre", label: "Nombre del cliente", type: "text", section: "datos_generales", editable_by: "tecnico", sort_order: 50 },
  { key: "cliente_apellido", label: "Apellido del cliente", type: "text", section: "datos_generales", editable_by: "tecnico", sort_order: 60 },
  { key: "alto_final_mm", label: "Alto final (mm)", type: "number", section: "datos_generales", editable_by: "tecnico", sort_order: 70 },
  { key: "ancho_final_mm", label: "Ancho final (mm)", type: "number", section: "datos_generales", editable_by: "tecnico", sort_order: 80 },
  { key: "fabricante_revestimiento", label: "Fabricante revestimiento", type: "text", section: "revestimiento", editable_by: "both", sort_order: 120 },
  { key: "lucera", label: "Lucera", type: "boolean", section: "revestimiento", editable_by: "both", sort_order: 130, options: ["si", "no"] },
  { key: "lucera_cantidad", label: "Cant. de luceras", type: "enum", section: "revestimiento", editable_by: "both", sort_order: 140, options: ["1", "2", "3", "4"] },
  { key: "lucera_posicion", label: "Posición de lucera", type: "text", section: "revestimiento", editable_by: "both", sort_order: 150 },
  { key: "color_revestimiento", label: "Color revestimiento", type: "text", section: "revestimiento", editable_by: "both", sort_order: 160 },
  { key: "color_sistema", label: "Color sistema", type: "text", section: "revestimiento", editable_by: "both", sort_order: 170 },
  { key: "listones", label: "Listones", type: "text", section: "revestimiento", editable_by: "both", sort_order: 180 },
  { key: "puerta", label: "Puerta", type: "boolean", section: "puerta_estructura", editable_by: "both", sort_order: 210, options: ["si", "no"] },
  { key: "posicion_puerta", label: "Posición de la puerta", type: "text", section: "puerta_estructura", editable_by: "both", sort_order: 220 },
  { key: "parantes.cant", label: "Parantes cantidad", type: "number", section: "puerta_estructura", editable_by: "both", sort_order: 230 },
  { key: "parantes.distribucion", label: "Parantes distribución", type: "text", section: "puerta_estructura", editable_by: "both", sort_order: 240 },
  { key: "pasador_manual", label: "Pasador manual", type: "boolean", section: "puerta_estructura", editable_by: "both", sort_order: 250, options: ["si", "no"] },
  { key: "instalacion", label: "Instalación", type: "boolean", section: "puerta_estructura", editable_by: "both", sort_order: 260, options: ["si", "no"] },
  { key: "anclaje", label: "Anclaje", type: "enum", section: "puerta_estructura", editable_by: "both", sort_order: 270, options: ["no", "lateral", "superior"] },
  { key: "piernas", label: "Piernas", type: "text", section: "puerta_estructura", editable_by: "both", sort_order: 280 },
  { key: "rebaje", label: "Rebaje", type: "boolean", section: "rebajes_suelo", editable_by: "both", sort_order: 310, options: ["si", "no"] },
  { key: "rebaje_altura", label: "Altura de rebaje", type: "enum", section: "rebajes_suelo", editable_by: "both", sort_order: 320, options: ["75mm", "100mm", "125mm"] },
  { key: "rebaje_lateral", label: "Rebaje lateral", type: "boolean", section: "rebajes_suelo", editable_by: "both", sort_order: 330, options: ["si", "no"] },
  { key: "rebaje_inferior", label: "Rebaje inferior", type: "boolean", section: "rebajes_suelo", editable_by: "both", sort_order: 340, options: ["si", "no"] },
  { key: "trampa_tierra", label: "Trampa de tierra", type: "boolean", section: "rebajes_suelo", editable_by: "both", sort_order: 350, options: ["si", "no"] },
  { key: "trampa_tierra_altura", label: "Altura trampa de tierra", type: "enum", section: "rebajes_suelo", editable_by: "both", sort_order: 360, options: ["2 cm", "5 cm"] },
  { key: "observaciones", label: "Observaciones", type: "text", section: "observaciones", editable_by: "both", sort_order: 410 },
];
...
export const BUDGET_FIELD_OPTIONS = [
  ...
  { value: "quote.odoo_sale_order_name", label: "Cotización · NV Odoo" },
  { value: "quote.final_sale_order_name", label: "Cotización · NV final" },
...
function normalizeBudgetProductValueKey(value) {
  ...
  return ["display_name", "alias", "raw_name", "code", "product_id", "presence_si_no"].includes(v)
    ? v
    : "display_name";
}
